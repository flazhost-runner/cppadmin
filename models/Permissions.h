...
#endif
public:
  static const constexpr char *tableName = "permissions";
  ...
  const std::string &getValueOfMethod()     const noexcept { static std::string d; return method_    ? *method_    : d; }
  ...
  void setMethod(const std::string &v)     { method_    = std::make_shared<std::string>(v); }
